...
export const UI: Record<string, I18n> = {
  ...
  // ── feladat, haladás, nyelv, segítség ────────────────────────────────
  "fn.start":       { hu: "Fő funkciók", en: "Main functions" },
  "fn.all":         { hu: "Minden mező", en: "All fields" },
  "fn.other":       { hu: "Egyebek", en: "Other" },
  "fn.planned":     { hu: "tervezett — még nincs mező", en: "planned — no fields yet" },
  "fn.fields":      { hu: "{n} mező", en: "{n} fields" },
  "fn.filled":      { hu: "{n} / {m}", en: "{n} / {m}" },
  "fn.virtual":     { hu: "más modulok mezőiből — egy mező egy helyen", en: "from other modules — each field in one place" },
  "ctx.strip":      { hu: "Kontextus", en: "Context" },
  "ctx.weeksDays":  { hu: "{w} hét + {d} nap", en: "{w} wk + {d} d" },
  "ctx.empty":      { hu: "Nincs rögzített terhességi kontextus — a referenciák nem választhatók.", en: "No pregnancy context recorded — reference ranges cannot be chosen." },
  "density.compact":{ hu: "Tömör", en: "Compact" },
  "density.roomy":  { hu: "Tágas", en: "Roomy" },
  "density.explain":{ hu: "Tömör: két oszlop, kisebb sorok, az azonosító csak ráállva.", en: "Compact: two columns, tighter rows, the id on hover only." },
  "feladat.title":  { hu: "Feladat", en: "Task" },
  "feladat.all":    { hu: "Betegút — minden modul", en: "Care pathway — all modules" },
  "feladat.explain":{ hu: "A feladat azt dönti el, mi van nyitva és elöl. Amit láthatsz, azt a jogosultságod dönti el — a feladat nem szűkít.",
                      en: "The task decides what is open and up front. What you may see is decided by your assignment — a task never narrows it." },
  "feladat.opened": { hu: "{n} modul nyitva ehhez a feladathoz", en: "{n} modules open for this task" },
  "halad.summary":  { hu: "{n} kitöltve · {v} látható mező · {t} összesen", en: "{n} filled · {v} visible fields · {t} in total" },
  "lang.coverage":  { hu: "{p}% klinikai címke", en: "{p}% clinical labels" },
  "lang.uiOnly":    { hu: "csak a felület", en: "interface only" },
  "field.hint":     { hu: "Mit érdemes tudni", en: "Worth knowing" },
  "meres.kritikus": { hu: "kritikus küszöbön kívül", en: "beyond critical threshold" },
  "meres.referencianKivul": { hu: "referencián kívül", en: "outside reference" },
  "meres.savban":   { hu: "sávban", en: "within band" },
  "meres.nemErtekelheto": { hu: "nem megállapítható", en: "cannot be assessed" },
  "meres.nincsKuszob": { hu: "nincs mihez mérni", en: "nothing to measure against" },
  "meres.referencia": { hu: "referenciatartomány", en: "reference range" },
  "meres.kritikusSav": { hu: "beavatkozási küszöb — nem referencia", en: "intervention threshold — not a reference" },
